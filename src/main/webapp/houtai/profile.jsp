				...
				<div class="container-fluid">
					<!-- 生活点滴 -->
							<div class="panel">
								...
								<form action="${pageContext.request.contextPath}/mform/insertSh" class="alt" method="POST">
								<div class="panel-heading">
											<img id ="shdemo"  alt="picture" src ="../pageResources/imgs/timg.jpg">
								...
								<div class="panel-body">
									<div class="input-group">
										...
										<input class="form-control" name="mc"  placeholder="名称" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="auth"  placeholder="作者" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="js"  placeholder="介绍" type="text">
									</div>
									<br>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-6"><span class="panel-note"></span></div>
										<div class="col-md-6 text-right"><a class="btn btn-primary" href ="${pageContext.request.contextPath}/mform/tshentrance">More</a></div>
									</div>
								</div>
							</div>
							<!-- END  -->
