			...
			<div class="main-content">
				<div class="container-fluid">
							<div class="panel">
								...
								<div class="panel-heading">
											<img id ="yxdemo"  alt="picture" src ="/xuxiaonan/uploadImages/${yx.getPicid()}">
									<button type="button" class="layui-btn" id="yxtest"></button>
									<input id ="yxid" name ="yxid" value ="${yx.getId()}" type ="hidden">
									<input id ="picNAme" name ="pname" type ="hidden">
									<input id ="picID" name ="pid" value ="${yx.getPicid()}" type ="hidden">
								...
								<div class="panel-body">
									<div class="input-group">
										...
										<input class="form-control" name="yxmc"  value ="${yx.getYxmc()}" placeholder="游戏名称" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="yxkfs"  value ="${yx.getYxkfs()}" placeholder="游戏开发" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="grgs"  value ="${yx.getGrgs()}" placeholder="简介" type="text">
									</div>
									<br>
