			...
			<div class="main-content">
				<div class="container-fluid">
							<div class="panel">
								...
								<form action="${pageContext.request.contextPath}/mform/insertSj" class="alt" method="POST">
								<div class="panel-heading">
											<img id ="sjdemo"  alt="picture" src ="../pageResources/imgs/timg.jpg">
									<button type="button" class="layui-btn" id="sjtest"></button>
								...
								<div class="panel-body">
									<div class="input-group">
										...
										<input class="form-control" name="tsmc"  placeholder="图书名称" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="tslx"  placeholder="图书类型" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="cbs"  placeholder="出版社" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="zbz"  placeholder="主编" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="price"  placeholder="价格" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="lanuage"  placeholder="语言" type="text">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="tjyy"  placeholder="推荐原因" type="text">
									</div>
									<br>
			 			   ...
			 			   ,url: '/xuxiaonan/upload/images'
			    			    ...
			    			    $('#sjdemo').attr('src', result); //图片链接（base64）
			    				  });
			  					  }
			  					  ,done: function(res){
			   				   //上传成功
							...
							<div class="panel">
								...
								<c:forEach items="${ts}" var="object"
									varStatus="status">
								<div class="panel-body">
									<h3 class="panel-title">${object.getTsmc()}</h3>
									<p class="panel-subtitle">${object.getTslx()}</p>
									<div class="col-md-6"><span class="panel-note"></span></div>
									<div class="col-md-6 text-right"><a href="${pageContext.request.contextPath}/mform/cksjentrance?id=${object.getId()}">编辑</a>|<a href="${pageContext.request.contextPath}/mform/deleteSj?id=${object.getId()}">删除</a></div>
								</div>
								</c:forEach>
								<div class="panel-body">
									<div class="row">
										<div class="col-md-6"><span class="panel-note"></span></div>
										<div class="col-md-6 text-right"><a class="btn btn-primary" href ="${pageContext.request.contextPath}/mform/tsjentrance">More</a></div>
									</div>
								</div>
							</div>
							<!-- END  -->
