...
function getyxIformation(){
//AJAX向后台请求数据
	$.ajax({
		type:'post',
		url:"${pageContext.request.contextPath}/travel/getyxIformation",
		sync:false,
...
function setHtml(data){
	...
	$(data).each(function(index,object){
		 s += '<div class="col-md-4"><div class="team-item"><div class="team-image"><a href ="${pageContext.request.contextPath}/travel/yxxsentrance?yxid='+object.id+'"><img src="/xuxiaonan/uploadImages/'+object.picid+'"class="img-responsive" alt="author"></a></div>';
		 s += '<div class="team-text"><h3>'+object.yxmc+'</h3><div class="team-position">'+object.yxkfs+'</div><p>'+object.grgs+'</p></div></div></div>';
	});
	if(data.length>0){
		$("#yxxs").html(s);
	}else{
		$("#yxxs").html("<br/><span style='width:10%;height:30px;display:block;margin:0 auto;'>暂无数据</span>");
	}
	console.log(s);
}
